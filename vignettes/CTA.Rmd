...
```  
As expected, trajectory of site '2' is less straight than trajectory of site '1'. Although it would be desirable, the function does not perform any statistical test on directionality.
