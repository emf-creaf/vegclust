...
can be used in other fields. The package provides functions to:
  ...
  - Perform fuzzy clustering of vegetation data \[De Caceres et al.
    (2010) <doi:10.1111/j.1654-1103.2010.01211.x>\]
  ...
  - Perform community trajectory analysis \[De Caceres et al. (2019)
