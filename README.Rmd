...
Until ver. 2.0, package `vegclust` included functions to conduct Community Trajectory Analysis (CTA). Since ver. 2.0 these functions have been moved to an independent package called 'ecotraj' at https://github.com/emf-creaf/ecotraj/.
