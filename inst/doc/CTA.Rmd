...
In this section we describe how to study the trajectories of two sites that have been surveyed three times each. We use a simple example so that geometric calculations can be followed more easily.
